//
//  endDetailViewController.m
//  worker
//
//  Created by ios_g on 2017/11/2.
...
@interface endDetailViewController ()<BMKLocationServiceDelegate, BMKMapViewDelegate>
{
...
@implementation endDetailViewController
...
- (void)initUI
{
    backview = [[[NSBundle mainBundle] loadNibNamed:@"Empty" owner:self options:nil] objectAtIndex:5];
    ...
    pingjia = [backview viewWithTag:1020];
    pingjia.layer.masksToBounds = YES;
    pingjia.layer.cornerRadius = 7.5;
...
- (void)pingjiaBtn
{
    ...
    temp.o_worker = guzhuID;
    temp.worName = skillsName;
    temp.t_id = t_id;
