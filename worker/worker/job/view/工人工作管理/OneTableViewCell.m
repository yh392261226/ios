...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        [_leftBtn.layer setMasksToBounds:YES];//设置按钮的圆角半径不会被遮挡
        _leftBtn.layer.borderColor = [UIColor grayColor].CGColor;
        [_leftBtn.layer setBorderWidth:1];//设置边界的宽度
        ...
        [_centerBtn.layer setMasksToBounds:YES];//设置按钮的圆角半径不会被遮挡
        _centerBtn.layer.borderColor = [UIColor grayColor].CGColor;
        [_centerBtn.layer setBorderWidth:1];//设置边界的宽度
...
- (void)layoutSubviews
{
    ...
    [_centerBtn mas_makeConstraints:^(MASConstraintMaker *make)
     {
         make.bottom.mas_equalTo(_backview).offset(-5);
         make.right.mas_equalTo(_rightBtn).offset(-90);
         make.height.mas_equalTo(25);
         make.width.mas_equalTo(80);
     }];
    ...
    [_leftBtn mas_makeConstraints:^(MASConstraintMaker *make)
     {
         make.bottom.mas_equalTo(_backview).offset(-5);
         make.right.mas_equalTo(_centerBtn).offset(-90);
         make.height.mas_equalTo(25);
         make.width.mas_equalTo(80);
     }];
}
