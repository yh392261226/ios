...
- (UITableView *)tableview
{
    if (!_tableview)
    {
        ...
        _tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 44 + StatusBarHeigh, SCREEN_WIDTH, SCREEN_HEIGHT - 44 - StatusBarHeigh) style:UITableViewStyleGrouped];
    ...
    //    self.automaticallyAdjustsScrollViewInsets = NO;    //关掉页面的自动布局
